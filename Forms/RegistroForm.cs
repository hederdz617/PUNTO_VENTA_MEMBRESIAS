...
namespace NuevoAPPwindowsforms.Forms
{
    public class RegistroForm : Form
    {
        ...
        private int _ultimoClienteId = -1;
        public RegistroForm(AppData data)
        {
            _data = data;
        ...
        private void BtnGuardar_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                _ = NuevoAPPwindowsforms.Services.TelegramService.EnviarMensajeAGrupoAsync(mensaje, NuevoAPPwindowsforms.Services.TelegramService.ChatIdRegistro);
            }
            catch (Exception ex)
            {
